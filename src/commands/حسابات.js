...
module.exports.run = async function ({ api, event }) {
  ...
  const TIERS = [
    {
      tier: 1,
      stateFile:  "sessions/ZAO-STATE.json",
      altFile:    "sessions/alt.json",
      credsFile:  "sessions/ZAO-STATEC.json"
    },
    {
      tier: 2,
      stateFile:  "sessions/ZAO-STATEX.json",
      altFile:    "sessions/altx.json",
      credsFile:  "sessions/ZAO-STATEXC.json"
    },
    {
      tier: 3,
      stateFile:  "sessions/ZAO-STATEV.json",
      altFile:    "sessions/altv.json",
      credsFile:  "sessions/ZAO-STATEVC.json"
    },
    {
      tier: 4,
      stateFile:  "sessions/ZAO-STATE4.json",
      altFile:    "sessions/alt4.json",
      credsFile:  "sessions/ZAO-STATE4C.json"
    },
    {
      tier: 5,
      stateFile:  "sessions/ZAO-STATE5.json",
      altFile:    "sessions/alt5.json",
      credsFile:  "sessions/ZAO-STATE5C.json"
    }
  ];
  ...
  for (const t of TIERS) {
    ...
    lines.push(`   🍪 ${path.basename(t.stateFile)}: ${fileInfo(t.stateFile)}`);
    lines.push(`   🍪 ${path.basename(t.altFile)}: ${fileInfo(t.altFile)}`);
    lines.push(`   📧 ${path.basename(t.credsFile)}: ${fileInfo(t.credsFile)}`);
    lines.push("");
  }
