...
// ─── ZAO Compatibility Shim ────────────────────────────────────────────────────
// ZAO commands use global.client and global.config.PREFIX — bridge to GoatBot globals
if (!global.client) global.client = global.GoatBot;
if (!global.config) global.config = config;
if (!global.config.PREFIX) global.config.PREFIX = config.prefix || "/";
